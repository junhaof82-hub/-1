...
class Settings:
    ...
    train_period: str = field(default_factory=lambda: _env('TRAIN_PERIOD', '5y'))
    model_version: str = field(default_factory=lambda: _env('MODEL_VERSION', 'max-v2.0'))
    monte_carlo_simulations: int = field(default_factory=lambda: _env_int('MONTE_CARLO_SIMULATIONS', 30000))
